...
beforeAll(async function (){
  try {
    ...
    insertedCity = await city.insertOne({
      ...
      stateId: 'interface',
      cityId: 'Manager',
      id: '6299b84d74d63acbc521737f'
    });
    const state = dbInstance.collection('states');
    insertedState = await state.insertOne({
      name: 'Judy Rice',
      countryId: 'Technician',
      country_code: 'enable',
      country_name: 'invoice',
      state_code: 'concept',
      stateId: 'mission-critical',
      id: '6299b84d74d63acbc5217380'
    });
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Tad16',
        'email':'Lorenza_Kertzmann52@gmail.com',
        'password':'I1C6wL65xungdt9',
        'clientId':'Western',
        'userType':authConstant.USER_TYPES.User,
        'mobileNo':'(215) 591-4224',
        'forgotPasswordToken':'experiences',
        'emailVerified':true,
        'firstName':'Lydia Predovic',
        'lastName':'Kelley Braun',
        'telephone':'transparent',
        'telephoneCountryCode':'EXE',
        'address1':'Unbranded',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    let user = await request(app)
      .post('/device/auth/forgot-password')
      .send({ 'email':'Lorenza_Kertzmann52@gmail.com', });
